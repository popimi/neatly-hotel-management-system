function RoomInformation() {
    return (
      <section className="w-[375px] h-[862px] flex flex-col top-[297px] gap-[24px]  lg:bg-purple-100 lg:w-[1440px] lg:h-[935px] lg:items-center">
       
       
       
       
       
        <div className="w-[343px] h-[344px] gap-[40px] m-[16px] lg:bg-yellow-50 lg:w-[738px] lg:h-[633px] lg:gap-[80px]">
          <br></br>
  
          <p className="font-[500] text-[44px] font-[noto] leading-[55px] text-green-800 lg:text-[68px] lg:leading-[85px]">
