...
function CarouselPictureLg() {
  return (
    <div className="hidden lg:flex lg:w-full lg:h-[281px]  lg:bg-green-200 ">
      <div className="lg:flex lg:flex-col lg:items-center  lg:w-full lg:h-[281px] lg:gap-[60px]">
        <div className="lg:carousel lg:carousel-center lg:bg-[#E6EBE9] lg:relative lg:max-w-[1692px] lg:max-h-[571px] lg:gap-[24px]">
          <div id="slide1" className="carousel-item">
            <img
              ...
              className=" lg:w-[500px] lg:h-[281px] lg:rounded"
            />
          </div>
          ...
          <div id="slide4" className="carousel-item">
            <img src={suite} className="lg:w-[500px] lg:h-[281px] lg:rounded" />
          </div>
        </div>
      </div>
    </div>
